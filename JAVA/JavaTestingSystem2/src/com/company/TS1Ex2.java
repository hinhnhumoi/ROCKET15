...
//        Tạo Position
        ...
        System.out.println("Account 1: ID : " + acc1.accountID + " Email: " +

                acc1.email + " UserName: " + acc1.userName

                + " FullName: " + acc1.fullName + " Department: " +

                acc1.departments.departmentName + " Position: "

                + acc1.positions.PositionName + " Group: "+
                acc1.groups[0].groupName +" "+ acc1.groups[1].groupName + "CreateDate: " +
                acc1.createDate);
    }
}
